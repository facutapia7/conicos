...
import ar.com.osde.cronicos.beans.Provincia;
 ...
 */
public class ProvinciaBO extends BusinessObject {
	
	/**
	 * Retoprna lista de Provincias
	...
	public List obtenerProvincias(){
    	GenericDAO gdao = (GenericDAO)DAOFactory.getInstance().getDAO(GenericDAO.class);
 		List provs = null;
 		try {
	    	provs = gdao.getAllObjects(Provincia.class);
